...
def populate():
    ...
    python_pages = [
        {'title': 'Official Python Tutorial',
         'url':'http://docs.python.org/3/tutorial/', 'views':54},
    ...
    django_pages = [
        {'title':'Official Django Tutorial',
         'url':'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views':130},
        {'title':'Django Rocks',
         'url':'http://www.djangorocks.com/', 'views':77},
    ...
    other_pages = [
        ...
        {'title':'Flask',
         'url':'http://flask.pocoo.org', 'views':124} ]
